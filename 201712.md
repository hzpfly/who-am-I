...
- how to import the dump file in 14b:
the command is mysql -f ipworks < "/ipworks.sql.conf" 
- how to truncate all table in a database
...
# TODO 12/15/2017 10:22:13 AM  #
## DB rule csv file check ##
## configruration rule check ##
## draft TA ##

# TODO 12/18/2017 10:23:10 AM  #
## TA ##
done
## TOL ##

- Is the NP case enough to cover the MRD Spanish-INAP?


    FrameworkLibs/FrameworkLibs_Common/src/INAP_CS1plus_Mapping.ttcn
    ProtocolModules/Ericsson_INAP_CS1plus_CNL113356/src/INAP_CS1plus_Types.ttcn
    ProtocolModules/Ericsson_INAP_CS1plus_CNL113356/src/Ericsson_INAP_CS1plus_Types.ttcn
    TestSuites/TS_NP/src/INAP_PRJ_60_WP04.ttcn

done. 1 TR related found. 2 TTCN cases found in FT CI. All passed in daily CI.    
## configruration rule check ##

## DNS forwarding ##
sent to PO. PO forward to Test-Co:)

## check the customer's 2nd backup and ASDNS status ##
...
- coding more, unless the grammar will be forgot

## question ##
- what is DNS SRV record?
- who should take the response of the test result?


# TODO 12/19/2017 9:55:18 AM  #
## Migration User Guide ##
1st version User Guide done. migration from 1.x to 1.x is not included.
## TA TOL review ##
done.
ASDNS need to be tested.
migration from 1.12 to 1.12 needs to be tested.


# TODO 12/20/2017 10:29:57 AM  #
## Review the code ##
done.
But there is a difference of DiscardErhFailure between 14b and 15b.

in 1.12, discardErhFailure = true means the failure is not discarded and the NXDOMAIN will be replied.

### deployment/upt/datamigrationtool/migration/enumerate_conf.py ###

## start to test on JDI or KVM? ##


dairy:
In the morning, mon and I went to the hospital. Mom has an allergy for 3 days. She suffered the itchiness and scratched all body. 
The doctor said it is an allergy. And gave 2 medicines. 
...
http://www.ems.com.cn/
CC441566564SE
http://ieng9.ucsd.edu/~cs30x/Std.C/index.html?1356437801
...
- cpp: http://ieng9.ucsd.edu/~cs30x/Std.C/string.html
- network ?
- English
- apue ?